const ApiKey = "1b08558e18f54e9485f7277d40d28787";
...
function showTeamInfo(id) {
    ...
    fetch(url, fetchHeader)
        ...
        .then(resJson => {
            ...
            title.innerHTML = "Nama Pemain " + shortName;
            contents.innerHTML = `
                <img src="${crestUrl}" alt="${name}" width="80px">
                <div class="divider"></div>
                <div class="section">
                <th>Nama Tim Bola    : ${name}</th> 
                </div>
                <div class="divider"></div>
                <div class="section">
                <th>Nama Stadion Tim : ${venue}</th>
                </div>
                <div class="divider"></div>
                <div class="section">
                <th>Tempat Stadion Tim      : ${address}</th>
                </div>
                <div class="divider"></div>
                <div class="section">
                <th>Liga Tim Bola    : ${activeCompetitions}</th>
                <br>
